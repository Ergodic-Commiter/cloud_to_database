...
CREATE UNIQUE NONCLUSTERED INDEX UX_PTLF_Token
ON dbo.PTLF_raw ([NGBBSE24-AUTH-TYP], [NGBBSE24-AUTH-POST-DAT], [NGBBSE24-HEAD-CRD-CARD-NUM], 
...
GO
DROP INDEX UX_PTLF_Token ON dbo.PTLF_raw; 
